...
- **Journal UI (built):** `J` in the world or Journal at the desk lists active quests with the current objective and the notes of finished stages, then finished and failed quests.
