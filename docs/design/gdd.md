...
- **General Store:** buy resources with gold at `economy.yaml` prices (Bazaar and Socialite bonuses discount them), sell at the sell rate, and buy the few gifts it stocks. Stock and industry effects are question H2.
